            ...
            <section class="text-gray-600 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto  object-cover object-top rounded" src="https://m.media-amazon.com/images/I/81YO4Qtc1mL._SY879_.jpg" />
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class="flex justify-between md:text-sm">
                                <span class="title-font font-medium text-2xl  text-gray-900">$58.00</span>
                                <button class="flex ml-2  text-white bg-purple-500 border-0 py-2 px-4 focus:outline-none hover:bg-purple-600 rounded">Buy Now</button>
                                <button onClick={() => { addToCart(slug, 1, 499, 'Wear the code (WL , blue)', 'XL', 'Blue') }} class="flex  text-white bg-purple-500 border-0 py-2 px-4 focus:outline-none hover:bg-purple-600 rounded">Add to cart</button>
                            ...
                            <div className="flex mt-6 ">
                                <input onChange={onChangePin} type="text" placeholder="Enter your pincode" className="border-purple-950 border-2 rounded-md px-2" />
