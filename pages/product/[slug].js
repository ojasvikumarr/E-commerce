            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto  object-cover object-top rounded" src="https://m.media-amazon.com/images/I/81YO4Qtc1mL._SY879_.jpg" />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex justify-between md:text-sm">
                                ...
                                <button className="flex ml-2  text-white bg-purple-500 border-0 py-2 px-4 focus:outline-none hover:bg-purple-600 rounded">Buy Now</button>
                                <button onClick={() => { addToCart(slug, 1, 499, 'Wear the code (WL , blue)', 'XL', 'Blue') }} className="flex  text-white bg-purple-500 border-0 py-2 px-4 focus:outline-none hover:bg-purple-600 rounded">Add to cart</button>
