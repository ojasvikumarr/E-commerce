...
export const ParallaxScroll = ({
  ...
  return (
    <div
      className={cn("h-[50rem] mt-10 items-start overflow-y-auto w-full [mask-image:linear-gradient(to_bottom,transparent,white_10%,white_90%,transparent)]", className)}
      ref={gridRef}
    >
      <div
        ...
        <div className="grid gap-10">
          {secondPart.map((el, idx) => (
            <motion.div style={{ y: translateSecond }} key={"grid-2" + idx}>
              <Image
                src={el}
                className="h-950 w-full object-cover object-left-top rounded-lg gap-10 !m-0 !p-0"
                height="800"
                width="400"
                alt="thumbnail"
              />
